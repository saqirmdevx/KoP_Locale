...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
  ...
  [LOCALE.BELLE_DESCRIPTION]: {
    en: "Belle was born in the heart of an ancient, magical forest, where nature and magic coexisted in perfect harmony. Her family were the guardians of this enchanted woodland, tasked with preserving its beauty and protecting its secrets. From a young age, Belle showed a unique affinity for the flora around her, able to communicate with plants and channel their natural energy through her magic.

One fateful day, a force of hermits invaded the forest, seeking to exploit its magical resources for their nefarious purposes. Belle's family fought valiantly to defend their home, but the enemy was too powerful. In a desperate bid to save the forest, Belle unleashed a powerful enchantment, intertwining her own life force with that of the forest. This act of selflessness granted her immense power but also bound her fate to the wellbeing of the woodland.

Now, as the Thorn Enchantress, Belle roams the land, using her magical abilities to protect nature and fight against those who would harm it. She is a symbol of resilience, embodying the strength and fragility of the natural world she cherishes.",
...
Теперь, став Чародейкой Шипов, Белла странствует по миру, защищая природу от рук тех, кто жаждет её разрушения. Она – воплощение стойкости и нежности, символ неукротимой силы и хрупкости природы, которую она столь заботливо охраняет.",
  ...
  [LOCALE.AREL_DESCRIPTION]: {
    ...
    ru: 'Пленённый ещё ребёнком в конце Войны Подчинения Демонов, объект D01, также известный как Арел, стал подопытным для Стражей в их исследованиях демонической магии. Годы психологических истязаний, физических экспериментов и принудительной имплантации магических каналов для демонической магии в его тело привели к почти полной слепоте и параличу левой ноги. Но когда пришло время ввести в него проклятую энергию, всё пошло не по плану. Крупица его человечности восстала и отвергла тёмную силу, породив взрыв магической энергии, который уничтожил лабораторию, где его держали, и погрузил его в кому.

Когда Арел очнулся, лишь одно чувство овладело его разумом: жажда мести. Вооружившись поясом с гранатами и пистолетом, он теперь бродит по окраинам земель Стражей, неся быструю смерть тем, кто обрёк его на годы страданий.',
  },
  [LOCALE.FOXY_DESCRIPTION]: {
    en: "Foxy was born into a family of survivalists deep in the forests. His parents, former military operatives, taught him everything they knew about survival, combat, and weaponry from a young age. Growing up in this harsh environment, Foxy developed a keen sense of awareness and a fierce independence. His skill with firearms and explosives quickly became apparent.
