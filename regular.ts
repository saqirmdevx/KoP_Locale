...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
  ...
  [LOCALE.TUTORIAL_HINT_BUY_ITEM]: {
    en: 'Buy Boots first, then buy one item in another slot.',
    ru: 'Сначала купите ботинки, затем купите один предмет в другой слот.',
    br: 'Compre botas primeiro, depois compre um item em outro espaço.',
    cz: 'Nejprve kup boty, potom jeden předmět do jiného slotu.',
    zh: '先购买鞋子，然后在另一个栏位购买一件物品。',
    fr: 'Achetez d’abord des bottes, puis un objet dans un autre emplacement.',
    id: 'Beli Boots dulu, lalu beli satu item di slot lain.',
    vi: 'Mua giày trước, sau đó mua một trang bị ở ô khác.',
  },
