...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
  ...
  [LOCALE.MATCH_DETAILS_GOLD_DIFFERENCE]: {
    ...
    zh: '金錢差距',
    fr: "Différence d'or",
    br: 'Diferença de Ouro',
    id: 'Selisih Emas',
    vi: 'Chênh lệch vàng',
    kr: `골드 차이`,
  },
  [LOCALE.MATCH_DETAILS_XP_DIFFERENCE]: {
    en: 'Experience Difference',
    ru: 'Разница опыта',
    cz: 'Rozdíl zkušeností',
    zh: '經驗差距',
    fr: "Différence d'expérience",
    br: 'Diferença de Experiência',
    id: 'Selisih Pengalaman',
    vi: 'Chênh lệch kinh nghiệm',
    kr: `경험치 차이`,
  },
