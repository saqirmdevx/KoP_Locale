...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
  ...
  [LOCALE.RECOMMENDED_ITEMS_FILTER_HINT]: {
    ...
    cz: 'Zobrazují se pouze doporučené předměty. Chcete-li zobrazit vše, vypněte v Nastavení možnost Zobrazovat pouze doporučené předměty.',
    zh: '目前僅顯示推薦物品。請在「設定」中關閉「僅顯示推薦物品」以查看所有物品。',
    fr: "Seuls les objets recommandés sont affichés. Désactivez 'Afficher uniquement les objets recommandés' dans les paramètres pour tout voir.",
    br: "Apenas os itens recomendados são exibidos. Desative 'Mostrar apenas itens recomendados' nas Configurações para ver tudo.",
    id: "Hanya item yang direkomendasikan yang ditampilkan. Nonaktifkan 'Tampilkan hanya item yang direkomendasikan' di Pengaturan untuk melihat semuanya.",
    vi: "Chỉ hiển thị các vật phẩm được đề xuất. Tắt 'Chỉ hiển thị vật phẩm được đề xuất' trong Cài đặt để xem tất cả.",
  },
  ...
  [LOCALE.DEATH_TIP_LAST_HIT]: {
    en: 'Last-hitting creeps provides bonus gold.',
