...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
  ...
  [LOCALE.TOURNAMENT_MATCH_ERROR_ALREADY_IN_GAME]: {
    en: 'Leave your current game, custom lobby, or spectate first, then ready for the tournament match.',
    ru: 'Сначала покиньте текущую игру, пользовательское лобби или просмотр, затем подтвердите готовность к турниру.',
    br: 'Saia do jogo atual, lobby personalizado ou espectação antes de confirmar presença no torneio.',
    cz: 'Nejdřív opusťte aktuální hru, vlastní lobby nebo sledování a potom potvrďte připravenost k turnaji.',
    zh: '請先離開目前的遊戲、自訂大廳或觀戰，再準備錦標賽比賽。',
    fr: "Quittez d'abord votre partie, lobby personnalisé ou mode spectateur, puis confirmez le match du tournoi.",
    id: 'Keluar dulu dari game, custom lobby, atau mode spectate saat ini, lalu siap untuk pertandingan turnamen.',
    vi: 'Hãy rời trận hiện tại, phòng tùy chỉnh hoặc chế độ xem trước, rồi sẵn sàng cho trận giải đấu.',
    kr: `현재 게임, 커스텀 로비 또는 관전을 먼저 나간 뒤 토너먼트 경기를 준비해 주세요.`,
  },
