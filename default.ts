...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
    ...
    [LOCALE.SPARROW_DESCRIPTION]: {
        ...
        <br />阿圖克拉斯，近乎於探索與見聞，對於史佩羅勇敢冒險，尋求未知以及探索情報的好奇心感到興趣。他漸漸打造出一條專門迎合史佩羅需求的道路，將其他想要追隨崇拜他的隱士們通通送遣走。史佩羅注意到了這些變動，但阿圖克拉斯向她保證，是命運選擇了這條道路，等著她的到來。在接下來幾年的訓練及準備中，隱士與惡魔的關係越來越緊密，而阿圖克拉斯向史佩羅透漏了他親屬的訊息。
