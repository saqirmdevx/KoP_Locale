...
const locale_data: { [key in LOCALE]: { [key in string]: string } } = {
    ...
    [LOCALE.KUMIHU_DESCRIPTION]: {
        ...
        cz: "Kumihu je zlý duch v převleku krásné ženy, která neustále touží po nových duších. Ale buďte opatrní: mrknutím oka může ukázat svou pravou podobu a zničit jakoukoli šanci na přežití, protože jeji sféra duše zachytí i ti nejhouževnatější blázni.",
    },
    [LOCALE.ICEAT_DESCRIPTION]: {
        ...
        cz: "I'ceat patřil ke kolonii tučňáků v arktické oblasti Civia, ale vzdy vyčníval mezi ostatními. Díky magickým schopnostem dokáže I'ceat projevit led a sníh na špičce svých kridel. Nikdo neví, kde se jeho síly vzaly , ale každý přijímá jeho jedinečnost ve kmenu. Kolébájíc se kolem vysokých stromů v hustém lese je I'ceat odhodlán najít skutečný význam za schopnostmi, které kdysi používal k ochraně své rodiny.",
    },
    ...
    [LOCALE.TRAINING_TOWER]: {
        ...
        cz: "Ale nejprve musíte zničit nepřátelskou věž!\n" +
            "NEÚTOČTE NA VĚŽ BEZ PESAKU! K tankování poškození věže potřebujete pesaky!\n" +
    ...
    [LOCALE.TRAINING_MINIONS]: {
        ...
        ru: "Это - ваши миньоны. Они появляются каждые 20 секунд!\n" +
            ...
            "\n\n[Нажмите пробел для продолжения!]",
        cz: "To jsou tvoji pesaci, lihnou se každých 20 sekund z tvého krystalu!\n" +
            "Zabitím nepřátelského pesaka získáte další zlato!\n" +
            "Použijte tyto pesaky k poškození tankové věže a zničení nepřátelského krystalu\n" +
            "Nepřátelští pesaci ti mohou ublížit, tak si na ně také dej pozor!" +
            "\n\n[Pokračujte stisknutím mezerníku!]",
    },
    ...
    [LOCALE.TRAINING_GOLD_RUNE]: {
        ...
        cz: "Nahoře najdete Zlatou runu! \n" +
            ...
            "První zlatá runa se objeví v 00:00 herniho casu!\n" +
            "\n\n[Pokračujte stisknutím mezerníku!]",
    },
    ...
    [LOCALE.TRAINING_BUSHES]: {
        ...
        ru: "Вы можете прятаться от противников в кустах! \n" +
            ...
            "\n\n[Нажмите пробел для продолжения!]",
        cz: "Můžeš se schovat před svými nepřáteli v keri! \n" +
            "Tady tě neuvidí, protože jsi schovaný, takže můžeš přepadnout své nepřátele ze zalohy!\n" +
    ...
    [LOCALE.TRAINING_ITEMS]: {
        ...
        ru: "Используйте Вашу мышь для покупки предметов! Наведите на пустой слот, а затем ПКМ по желаемому предмету для покупки!\n" +
            ...
            "\n\n[Нажмите пробел для продолжения!]",
        cz: "K nákupu predmetu pouzijte myš\n" +
            "Vybírejte své predmety moudře! Pokud predmet nechcete, můžete kliknout pravým tlačítkem u mysi a prodat ji.\n" +
            "Prodáte-li predmet 5 sekund po jeho zakoupení, vrati se vam pouze 50 % jeho hodnoty!\n" +
            "S klávesovými zkratkami [1, 2, 3, 4] lze použít nektere (Aktivovatelné) predmetu!\n" +
    ...
    [LOCALE.TRAINING_ABILITES]: {
        ...
        ru: "Внизу Вы можете увидеть способности своего героя\n" +
            ...
            "\n\n[Нажмите пробел для продолжения!]",
        cz: "Ve spodní části okna vidíte schopnosti svého hrdiny!\n" +
            "[J] [K] [L] jsou klavesy pro vaše útoky / schopnosti\n" +
            "[B] je Odvolání pro teleportování zpět do vaši základny! Pri pouziti bude trvat 5 sekund, než se teleportujete.\n" +
    ...
    [LOCALE.TRAINING_PLAY]: {
        ...
        cz: "Vaším cílem je nyní porazit nepřátelského bota! \n" +
            ...
            "Pomocí klaves W skocis a S sestoupis z platformy\n" +
    ...
    [LOCALE.FULL_SCREEN]: {
        ...
        cz: "Zapnout rezim plne obrazovky",
    },
    ...
    [LOCALE.POPUP_SELECT_MESS_GUESTMODE]: {
        ...
        cz: "Máte omezený přístup ke hře! Vaš pokrok bude ztracen když ukončíte prohlížeč...<br /> Připojte svůj <b style='color: red'>účet G-Mail</b> a získejte přístup ke všem funkcím. a žádné reklamy !",
    },
    ...
    [LOCALE.POPUP_SELECT_FIRST_TIME_TRAINING]: {
        ...
        cz: "Nejprve musis projít tréninkem nez budes moct hrát proti hráčům!",
    },
