    ...
    case ItemList.Plate_Armor: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng khả năng hồi máu nhận vào, hồi máu theo thời gian và khả năng khiên thêm ${healingAmp}% cho bản thân</c:bonus>.`,
    ...
    case ItemList.Wizard_Shoes:
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Giảm thời gian hồi chiêu và giảm thời gian hoạt ảnh</c:bonus>.`,
    ...
    case ItemList.Kirins_Boots:
      return {
        ...
        descPassive: {
          ...
          vi: `Giảm thời gian của <c:control>các hiệu ứng khống chế (choáng, làm chậm, trói chân, câm lặng)</c:control>.`,
    ...
    case ItemList.Shadow_Slayer: {
      ...
      return {
        ...
        descPassive2: {
          ...
          vi: `Lời Nguyền Bóng Tối: <c:magical>Giảm ${fixed(ItemAbilityData.GRIVEOUS_WOUND_65 * 100, 0)}% hồi máu, hồi phục máu và khiên của mục tiêu</c:magical>, đồng thời gây <c:pure>sát thương chuẩn</c:pure> dựa trên lượng hồi phục máu của kẻ địch.`,
    ...
    case ItemList.Divine_Sword: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Mỗi ${stacksRequired} đòn đánh trúng liên tiếp sẽ tạo một khiên <c:bonus>hấp thụ ${shieldBase} + ${shieldAdPercent}% sát thương vật lí</c:bonus>.`,
    ...
    case ItemList.Divine_Katana: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Ném một thanh katana xuống đất. Kẻ địch gần đó bị <c:slow>giảm ${slow}% tốc chạy</c:slow> và chịu hiệu ứng <c:control>câm lặng</c:control>.\nĐồng thời <c:vision>phát hiện các đơn vị tàng hình</c:vision>.`,
    ...
    case ItemList.Spiked_Mace: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Lập tức kết liễu kẻ địch dưới <c:health>${threshold}% máu tối đa</c:health>.`,
        ...
        descPassive2: {
          ...
          vi: `Hạ gục tướng địch nhận thêm <c:bonus>${killMoveSpeed}% tốc chạy</c:bonus>.`,
    ...
    case ItemList.Plague_Ring: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng thời gian của tất cả hiệu ứng tiêu cực lên tướng địch thêm ${duration}%</c:bonus>.`,
    ...
    case ItemList.Corrupted_Light_Slayer: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Bạn và đồng minh gần đó <c:bonus>nhận ${lifesteal} khát máu</c:bonus> và <c:bonus>${attackDamage} sát thương vật lý</c:bonus>.`,
    ...
    case ItemList.Berserkers_Bow: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Cho hiệu ứng Cuồng Nộ, cộng dồn tối đa ${maxStacks} lần. Mỗi lần cộng dồn <c:bonus>tăng ${attackSpeed}% tốc đánh</c:bonus> <c:bonus>(tối đa ${maxAttackSpeed}% tốc đánh)</c:bonus>. Ở ${maxStacks} lần cộng dồn còn thêm <c:bonus>${maxStacksLifesteal}% khát máu</c:bonus>.`,
      ...
      return {
        ...
        descPassive: {
          ...
          cz:
            ...
            getPoisonBowDescription(true),
          vi:
            `Gây <c:magical>sát thương phép</c:magical> sẽ nhận ${moveSpeed}% tốc chạy và áp dụng hiệu ứng Độc.\n\n` +
            getPoisonBowDescription(true),
          id:
    ...
    case ItemList.Corrupted_Longbow: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Cường hóa bản thân: <c:bonus>tăng ${attackSpeed}% tốc đánh</c:bonus> và <c:bonus>${moveSpeed}% tốc chạy</c:bonus>. Không thể sử dụng kỹ năng khi đang kích hoạt.`,
    ...
    case ItemList.Hunters_Longbow: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Áp dụng hiệu ứng Thợ Săn Tập Trung. <c:bonus>Tăng ${moveSpeed}% tốc chạy</c:bonus> và <c:dispel>miễn nhiễm với các hiệu ứng làm chậm</c:dispel>.`,
    ...
    case ItemList.Vampiric_Staff: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Kỹ năng gây <c:magical>${leechValue} (+ ${leechMod}% sức mạnh phép) sát thương phép</c:magical> cộng thêm và hồi máu gấp đôi lượng đó.`,
    ...
    case ItemList.Corrupted_Staff: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng ${bonusAp}% sức mạnh phép</c:bonus>.`,
    ...
    case ItemList.Frozen_Staff:
      return {
        ...
        descPassive: {
          ...
          vi: `Kỹ năng áp dụng hiệu ứng Băng Giá Phép Thuật (tối đa ${ItemAbilityData.FROZEN_STAFF_STACKS} lần cộng dồn). Khi cộng dồn tối đa, áp dụng Lời Nguyền Băng Giá.\n\n${getFrigidCurseDescription()}`,
    ...
    case ItemList.Divine_Staff: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `<c:heal>Hồi ${heal} máu</c:heal> và <c:bonus>tăng ${speed}% tốc chạy</c:bonus> cho bản thân và đồng minh ở gần.\n\n${getItemEffectPreventionDescription()}`,
    ...
    case ItemList.Vampiric_Shield: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Khi nhận sát thương từ tướng địch khiến <c:health>máu giảm xuống dưới ${threshold}%</c:health>, nhận khiên <c:bonus>hấp thụ ${ItemAbilityData.VAMPIRIC_SHIELD_ABSORPTION} sát thương</c:bonus>. Khi hết khiên, hồi máu bằng lượng đã hấp thụ.`,
    ...
    case ItemList.Divine_Armor: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Ban cho bản thân và đồng minh gần khiên thần thánh, <c:bonus>hấp thụ ${absorption} sát thương nhận vào tiếp theo</c:bonus> và <c:bonus>cung cấp ${tenacity}% kháng khống chế</c:bonus> trong thời gian kích hoạt.\n\n${getItemEffectPreventionDescription()}`,
    ...
    case ItemList.Plate_Shield: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Phóng sóng xung kích, phát hiện kẻ địch tàng hình, gây <c:physical>${ItemAbilityData.PLATE_SHIELD_DAMAGE_AOE} sát thương vật lý</c:physical>, <c:slow>giảm ${moveSpeedSlow}% tốc chạy</c:slow> và <c:slow>${attackSpeedSlow}% tốc đánh</c:slow>.`,
    ...
    case ItemList.Kirins_Defender: {
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Chặn hiệu ứng khống chế tiếp theo và ban cho miễn nhiễm khống chế</c:bonus>.`,
    ...
    case ItemList.Demon_Sabre: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Áp dụng hiệu ứng Suy Yếu Quỷ, cộng dồn tối đa ${maxStacks} lần. Mỗi lần cộng dồn <c:physical>giảm ${armorReduction} giáp</c:physical> <c:physical>(tối đa ${maxArmorReduction} giáp)</c:physical>.`,
    ...
    case ItemList.Void_Band: {
      ...
      return {
        ...
        descPassive2: {
          ...
          vi: `Hạ gục tướng địch nhận <c:bonus>${killAbilityHaste} giảm hồi chiêu</c:bonus>.`,
    ...
    case ItemList.Divine_Ring: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `<c:dash>Tốc biến</c:dash> về phía trước khi kích hoạt.`,
    ...
    case ItemList.Chronos_Ring: {
      ...
      return {
        ...
        descPassive2: {
          ...
          vi: `Hạ gục hoặc hỗ trợ sẽ đặt lại hồi chiêu kỹ năng (không ảnh hưởng đến thời gian hồi chiêu của đồ).`,
    ...
    case ItemList.Ring_Of_Inner_Fire: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Cháy dần: Gây <c:magical>sát thương phép</c:magical> lên tướng địch sẽ <c:magical>thiêu đốt chúng ${burn}% lượng sát thương đó trong ${burnDuration} giây</c:magical> và <c:magical>giảm ${magicResistance}% kháng phép của chúng</c:magical>. Thời gian hồi tính riêng cho từng mục tiêu.`,
    ...
    case ItemList.Frost_Armor: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:slow>Giảm tốc đánh của kẻ địch gần đó ${attackSpeedReduction}%</c:slow> và <c:lifesteal>giảm hiệu quả hồi máu, hồi phục và khát máu ${reduction}%</c:lifesteal>.`,
    ...
    case ItemList.Void_Armor: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Nhận <c:bonus>trạng thái tàng hình</c:bonus> và <c:bonus>+${moveSpeed}% tốc chạy</c:bonus>.\n\nDùng kỹ năng hoặc tấn công sẽ loại bỏ trạng thái tàng hình và nhận thêm +<c:physical>${ItemAbilityData.VOID_ARMOR_BONUS_DAMAGE} sát thương vật lí</c:physical>, trong khi <c:bonus>tốc chạy bonus</c:bonus> vẫn được duy trì.`,
    ...
    case ItemList.Vampiric_Armor: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Khi kích hoạt, <c:dispel>loại bỏ tất cả hiệu ứng tiêu cực</c:dispel> và trong thời gian có hiệu lực <c:heal>hồi lại ${value}% sát thương gây ra thành máu</c:heal>.`,
    ...
    case ItemList.Cloak_Of_Nature: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Mỗi lần chịu bất kỳ sát thương nào <c:bonus>nhận +${magicResistPerStack} kháng phép</c:bonus> và <c:heal>+${hpRegenPerStack} hồi máu</c:heal>, cộng dồn tối đa ${maxStacks} lần. Khi đạt tối đa cộng dồn, còn nhận thêm <c:bonus>+${maxStackMoveSpeed}% tốc chạy</c:bonus> và <c:bonus>+${maxStackAttackSpeed}% tốc đánh</c:bonus>.`,
    ...
    case ItemList.Cloak_Of_Light:
      return {
        ...
        descPassive: {
          ...
          vi: `Nhận hiệu ứng <c:vision>Nhìn Xuyên Thấu</c:vision>, phát hiện các đơn vị tàng hình trong tầm nhìn của bạn.`,
    ...
    case ItemList.Antimagic_Cape: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `<c:dispel>Loại bỏ tất cả hiệu ứng tiêu cực</c:dispel>. Miễn nhiễm khống chế và <c:bonus>+${totalMagicResistance} kháng phép</c:bonus>.`,
    ...
    case ItemList.Bloodweaver_Cloak: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Khế Ước Máu: Đánh trúng kẻ địch bằng kỹ năng sẽ <c:health>hy sinh ${sacrifice}% máu hiện tại</c:health> và <c:magical>tăng ${amplification}% sức mạnh phép của bạn</c:magical>.`,
        ...
        descPassive2: {
          ...
          vi: `<c:bonus>Cung cấp +${abilityPower} sức mạnh phép cho bản thân và đồng minh gần</c:bonus>.`,
    ...
    case ItemList.Titans_Armor: {
      return {
        ...
        descActive: {
          ...
          vi:
            `<c:immune>Miễn nhiễm với mọi sát thương</c:immune> và <c:dispel>loại bỏ tất cả hiệu ứng tiêu cức</c:dispel>.\n\n` +
            `<c:heal>Nhận +${ItemAbilityData.TITANS_ARMOR_REGENERATION} hồi máu</c:heal>.\n\n` +
            `Không thể di chuyển hoặc sử dụng kỹ năng, đòn đánh hay kích hoạt đồ trong thời gian có hiệu lực.`,
    ...
    case ItemList.Chest_Of_Malevolence: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Cung cấp +${tenacity}% kháng khống chế và +${moveSpeed}% tốc chạy cho bản thân và đồng minh gần</c:bonus>.`,
    ...
    case ItemList.Healing_Potion: {
      return {
        ...
        descActive: {
          ...
          vi: `Uống bình máu. Tăng ${ItemAbilityData.HEALING_POTION_HEAL_PER_SEC} hồi phục máu. Hiệu ứng mất khi nhận sát thương.`,
    ...
    case ItemList.Vile_Flask: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Ném Bình Độc phát nổ khi chạm đất. Kẻ địch ảnh hưởng bị <c:slow>giảm ${slow}% tốc chạy</c:slow> và nhận <c:magical>${ItemAbilityData.VILE_FLASK_DAMAGE_PER_SEC} sát thương phép</c:magical> mỗi giây.`,
    ...
    case ItemList.Potion_Of_Magic:
      return {
        ...
        descActive: {
          ...
          vi: `Uống bình thuốc phép. Nhận cộng dồn <c:bonus>vĩnh viễn</c:bonus> (tối đa 5). Mỗi lần cộng dồn <c:bonus>tăng sức mạnh phép thêm ${ItemAbilityData.POTION_OF_MAGIC_ABILITY_POWER}</c:bonus>.`,
    ...
    case ItemList.Potion_Of_Vitality:
      return {
        ...
        descActive: {
          ...
          vi: `Uống bình thuốc sinh lực. Nhận cộng dồn <c:bonus>vĩnh viễn</c:bonus> (tối đa 5). Mỗi lần cộng dồn <c:bonus>tăng máu tối đa thêm ${ItemAbilityData.POTION_OF_VITALITY_MAX_HEALTH}</c:bonus>.`,
    ...
    case ItemList.Burning_Arbalest: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Áp dụng hiệu ứng thiêu đốt, gây <c:magical>${dotPercent}% máu tối đa của mục tiêu dưới dạng sát thương phép</c:magical> mỗi giây.`,
    ...
    case ItemList.Divine_Arbalest: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:slow>Giảm ${critSlow}% tốc chạy của mục tiêu</c:slow>.`,
        ...
        descPassive2: {
          ...
          vi: `<c:bonus>Tăng ${auraAttackSpeed}% tốc đánh</c:bonus> cho đồng minh gần đó.`,
    ...
    case ItemList.Garuns_Charm: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Mỗi ${cooldown} nhận một lần cộng dồn Bảo Vệ Garun, tối đa ${ItemAbilityData.GARUNS_CHARM_MAX_STACKS}.\nNhận sát thương thường sẽ hủy bỏ một lần cộng dồn.\nMỗi lần cộng dồn tăng +${ItemAbilityData.GARUNS_CHARM_BONUS_ARMOR_STACK} giáp.`,
    ...
    case ItemList.Wizard_Charm: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Gây <c:magical>${percDmg}% máu tối đa của kẻ địch dưới dạng sát thương phép</c:magical>.`,
        ...
        descPassive2: {
          ...
          vi: `Lời Nguyền Phù Thủy: <c:magical>Giảm ${fixed(ItemAbilityData.GRIVEOUS_WOUND_65 * 100, 0)}% hồi máu, hồi phục máu và hiệu quả khiên của mục tiêu</c:magical>, đồng thời gây <c:pure>sát thương chuẩn</c:pure> dựa trên lượng hồi phục máu của kẻ địch.`,
    ...
    case ItemList.Corrupted_Locket: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Gây sát thương bằng kỹ năng sẽ lan tỏa trong bán kính ${spreadRadius}, gây <c:magical>${spreadPercent}% + ${spreadFlat} sát thương phép</c:magical> và <c:slow>giảm ${spreadSlow}% tốc chạy</c:slow> lên kẻ địch gần đó.`,
    ...
    case ItemList.Titans_Shield: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Sát thương từ tướng địch khiến <c:health>Máu của bạn giảm xuống dưới ${healthThreshold}%</c:health> sẽ bị chặn. Bạn <c:dispel>loại bỏ mọi hiệu ứng tiêu cực</c:dispel> và <c:immune>miễn nhiễm với toàn bộ sát thương</c:immune>, nhưng không thể tấn công hoặc dùng kỹ năng trong thời gian kích hoạt.`,
    ...
    case ItemList.Void_Sword: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Thả một thanh kiếm đi theo chủ nhân.\nĐồng minh gần đó nhận <c:bonus>+${movespeed}% tốc chạy</c:bonus> và <c:bonus>+${attackspeed} tốc đánh</c:bonus>.\nKẻ địch trong phạm vi bị <c:slow>giảm ${movespeed}% tốc chạy</c:slow> và <c:slow>giảm ${attackspeed} tốc đánh</c:slow>.`,
    ...
    case ItemList.Kirins_Sword: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `<c:dash>Lướt</c:dash> về phía trước. <c:bonus>Tăng ${attackSpeed}% tốc đánh</c:bonus> và <c:bonus>${moveSpeed}% tốc chạy</c:bonus>.`,
...
const getPoisonBowDescription = (isUpgraded: boolean) => {
  ...
  const text: { [key: string]: string } = {
    ...
    vi: `Gây hiệu ứng Độc không gây kết liễu (tối đa ${maxStacks} cộng dồn). Mỗi lần cộng dồn <c:slow>giảm ${slow} tốc chạy</c:slow> và gây <c:magical>${damageOverTime} sát thương phép</c:magical> mỗi giây.`,
...
const getIronRodDescription = () => {
  ...
  const text: { [key: string]: string } = {
    ...
    vi: `Kỹ năng trúng mục tiêu sẽ nhận buff. Đòn đánh tiếp theo gây <c:magical>${baseDamage} (+${bonusDamage}% sức mạnh phép) sát thương phép</c:magical>.`,
...
const getFrigidCurseDescription = () => {
  ...
  const text: { [key: string]: string } = {
    ...
    vi: `<c:slow>Lời Nguyền Băng Giá: giảm tốc chạy ${slow}, tốc đánh ${attackSpeed}% và hồi máu ${healingReduction}%</c:slow>`,
...
const getObserverWardDescription = () => {
  const text: { [key: string]: string } = {
    ...
    vi: `Đặt một Mắt Quan Sát. <c:vision>Cung cấp tầm nhìn</c:vision> và <c:vision>phát hiện đơn vị tàng hình</c:vision>. Vô hình với kẻ địch. Bị phá hủy nếu bị phát hiện.`,
...
const getNimbleBowDescription = () => {
  ...
  return {
    ...
    vi: `<c:bonus>Tăng tầm bắn và vùng ảnh hưởng thêm ${range} px, và tăng ${speed} tốc độ đạn</c:bonus>.`,
