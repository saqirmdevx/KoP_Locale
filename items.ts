    ...
    case ItemList.Plate_Armor: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng khả năng hồi máu nhận vào, hồi máu theo thời gian và hiệu quả khiên thêm ${healingAmp}% cho bản thân</c:bonus>.`,
    ...
    case ItemList.Wizard_Shoes:
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Giảm thời gian hồi chiêu và tăng tốc hoạt ảnh</c:bonus>.`,
    ...
    case ItemList.Spiked_Mace: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Lập tức kết liễu kẻ địch <c:health>dưới ${threshold}% máu tối đa</c:health>.`,
    ...
    case ItemList.Plague_Ring: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng thời gian của tất cả hiệu ứng lên tướng địch thêm ${duration}%</c:bonus>.`,
    ...
    case ItemList.Vampiric_Staff: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `Kỹ năng gây <c:magical>${leechValue} (+ ${leechMod}% sức mạnh phép thuật) sát thương phép</c:magical> cộng thêm và hồi máu gấp đôi lượng đó.`,
    ...
    case ItemList.Corrupted_Staff: {
      ...
      return {
        ...
        descPassive: {
          ...
          vi: `<c:bonus>Tăng ${bonusAp}% sức mạnh phép thuật</c:bonus>.`,
    ...
    case ItemList.Frozen_Staff:
      return {
        ...
        descPassive: {
          ...
          vi: `Kỹ năng áp dụng hiệu ứng Băng Giá Ma Thuật (tối đa ${ItemAbilityData.FROZEN_STAFF_STACKS} lần cộng dồn). Khi cộng dồn tối đa, áp dụng Lời Nguyền Băng Giá.\n\n${getFrigidCurseDescription()}`,
    ...
    case ItemList.Plate_Shield: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Phóng sóng xung kích, phát hiện kẻ địch, gây <c:physical>${ItemAbilityData.PLATE_SHIELD_DAMAGE_AOE} sát thương vật lý</c:physical>, <c:slow>giảm ${moveSpeedSlow}% tốc chạy</c:slow> và <c:slow>${attackSpeedSlow}% tốc đánh</c:slow>.`,
    ...
    case ItemList.Void_Armor: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Nhận <c:bonus>trạng thái tàng hình</c:bonus> và <c:bonus>+${moveSpeed}% tốc chạy</c:bonus>.\n\nDùng kỹ năng hoặc tấn công sẽ hủy tàng hình và nhận thêm +<c:physical>${ItemAbilityData.VOID_ARMOR_BONUS_DAMAGE} Sát Thương Vật Lý</c:physical>, trong khi <c:bonus>bonus tốc chạy</c:bonus> vẫn được duy trì.`,
    ...
    case ItemList.Bloodweaver_Cloak: {
      ...
      return {
        ...
        descPassive2: {
          ...
          vi: `<c:bonus>Cung cấp +${abilityPower} sức mạnh phép thuật cho bản thân và đồng minh gần</c:bonus>.`,
    ...
    case ItemList.Vile_Flask: {
      ...
      return {
        ...
        descActive: {
          ...
          vi: `Ném Bình Độc phát nổ khi chạm đất. Kẻ địch bị ảnh hưởng bị <c:slow>giảm ${slow}% tốc chạy</c:slow> và nhận <c:magical>${ItemAbilityData.VILE_FLASK_DAMAGE_PER_SEC} sát thương phép</c:magical> mỗi giây.`,
    ...
    case ItemList.Potion_Of_Magic:
      return {
        ...
        descActive: {
          ...
          vi: `Uống bình thuốc phép. Nhận cộng dồn <c:bonus>vĩnh viễn</c:bonus> (tối đa 5). Mỗi cộng dồn <c:bonus>tăng sức mạnh phép thuật thêm ${ItemAbilityData.POTION_OF_MAGIC_ABILITY_POWER}</c:bonus>.`,
...
const getPoisonBowDescription = (isUpgraded: boolean) => {
  ...
  const text: { [key: string]: string } = {
    ...
    vi: `Gây hiệu ứng Độc không gây kết liễu (tối đa ${maxStacks} cộng dồn). Mỗi cộng dồn <c:slow>giảm ${slow} tốc chạy</c:slow> và gây <c:magical>${damageOverTime} sát thương phép</c:magical> mỗi giây.`,
...
const getIronRodDescription = () => {
  ...
  const text: { [key: string]: string } = {
    ...
    vi: `Kỹ năng trúng mục tiêu sẽ nhận hiệu ứng. Đòn đánh tiếp theo gây <c:magical>${baseDamage} (+${bonusDamage}% sức mạnh phép thuật) sát thương phép</c:magical> bổ sung.`,
