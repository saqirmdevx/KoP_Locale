  ...
  switch (itemId) {
    ...
    case ItemList.Sentinel_longbow:
      return {
        ...
        desc: {
          en: `Increase range of bullets by ${ItemAbilityData.RESILIENT_BOW_BULLET_RANGE} and speed by ${(
    ...
    case ItemList.Plate_Armor:
      return {
        ...
        desc: {
          en: `Amplify all healing and regeneration effects by ${Math.floor(
    ...
    case ItemList.Shadow_Slayer:
      return {
        ...
        desc: {
          en: `When ready, your attack deals additional ${(ItemAbilityData.SHADOW_SLAYER_PERC_DMG * 100).toFixed(
            1
          )}% of enemy's max health, reduce his current health regen to 0 and deals ${
            ItemAbilityData.SHADOW_SLAYER_HP_REGEN_MODIFIER
          } times more damage over ${toSec(ItemAbilityData.SHADOW_SLAYER_DURATION)}.`,
    ...
    case ItemList.Divine_Sword:
      return {
        ...
        desc: {
          en: `Makes you immune to all incoming damage for ${toSec(
            ItemAbilityData.DIVINE_SWORD_DURATION
          )} and decreases your Attack Damage by 75%.`,
    ...
    case ItemList.Iron_Basher:
      return {
        ...
        desc: {
          en: `Your normal attack instantly kills the enemy when the enemy's health is below ${(
    ...
    case ItemList.Plague_Ring:
      return {
        ...
        desc: {
          en: `Increase duration by ${Math.floor(
            ItemAbilityData.PLAGUE_RING_MODIFIER * 100
          )}% of all negative effects applied by your abilities.`,
    ...
    case ItemList.Cold_Sword:
      return {
        ...
        desc: {
          en: `Your basic attacks apply stacks on the enemy. Upon reaching ${
    ...
    case ItemList.Corrupted_Light_Slayer:
      return {
        ...
        desc: {
          ...
          br: `Concede ${(ItemAbilityData.CORRUPTED_LIGHT_SLAYER_LIFESTEAL * 100).toFixed(1)}% de roubo de vida e ${
            ItemAbilityData.CORRUPTED_LIGHT_SLAYER_HPREGEN
          } regeneração de vida para aliados próximos.`,
          fr: `Octroie ${(ItemAbilityData.CORRUPTED_LIGHT_SLAYER_LIFESTEAL * 100).toFixed(
            1
          )}% de récupération de vie et ${
            ItemAbilityData.CORRUPTED_LIGHT_SLAYER_HPREGEN
          } de régénération de vie aux alliés proches.`,
          zh: `为附近的盟友提供${(ItemAbilityData.CORRUPTED_LIGHT_SLAYER_LIFESTEAL * 100).toFixed(1)}%的吸血和${
            ItemAbilityData.CORRUPTED_LIGHT_SLAYER_HPREGEN
          }生命回复。`,
          cz: `Poskytuje ${(ItemAbilityData.CORRUPTED_LIGHT_SLAYER_LIFESTEAL * 100).toFixed(1)}% Lifesteal a ${
            ItemAbilityData.CORRUPTED_LIGHT_SLAYER_HPREGEN
          } regeneraci zdraví blízkým spojencům.`,
        },
      }
    /** Wooden Bow */
    case ItemList.Berserker_Bow:
      return {
        ...
        desc: {
          en: `Every time your basic attacks hit enemy heroes, you gain ${Math.floor(
            ItemAbilityData.BERSERKER_BOW_BONUS_ATTACK_SPEED * 100
          )}% bonus Attack Speed for ${(ItemAbilityData.BERSERKER_BOW_DURATION / 1000).toFixed(1)} seconds.`,
    ...
    case ItemList.Magical_Bow:
      return {
        ...
        desc: {
          en:
            'When you damage the enemy hero with an ability, you gain 10 bonus Movement Speed for 1.5 seconds. \n \n' +
    ...
    case ItemList.Corrupted_Longbow:
      return {
        ...
        desc: {
          en:
            `Corrupts your blood and makes you powerful, giving you bonus ${
              ItemAbilityData.CORRUPTED_LONGBOW_BONUS_ATTACK_SPEED * 100
            }% Attack Speed and ${ItemAbilityData.CORRUPTED_LONGBOW_BONUS_MOVESPEED} Movement Speed for ${(
    ...
    case ItemList.Hunters_Longbow:
      return {
        ...
        desc: {
          en: `Increases the attack speed of all nearby friendly units by ${(
    ...
    case ItemList.Burning_Rod:
      return {
        ...
        desc: {
          en: `Your abilites ignite the enemy hero and deal Magical Damage equal to ${fixed(
            ItemAbilityData.BURNING_ROD_DAMAGE_OVER_TIME_PERC * 100,
            1
          )}% of their Max Health for ${(ItemAbilityData.BURNING_ROD_DURATION / 1000).toFixed(1)} sec`,
    ...
    case ItemList.Kirin_Staff:
      return {
        ...
        desc: {
          en: `Your abilities lower the enemy's Magic Resistance by ${fixed(
            ItemAbilityData.KIRIN_STAFF_MAGIC_RESISTANCE_REDUCTION * 100,
            1
          )}% for 4 seconds. This effect does not stack with other sources.`,
    ...
    case ItemList.Frozen_Staff:
      return {
        ...
        desc: {
          en: `Your abilities apply stacks on the enemy. Upon reaching ${
    ...
    case ItemList.Orchid_of_Malevolence:
      return {
        ...
        desc: {
          en:
            `Shoots a dark arrow that pierces through enemies, silencing them for ${(
              ItemAbilityData.ORCHID_OF_MALEVOLENCE_DURATION / 1000
            ).toFixed(1)} seconds. At the end of its duration, ${(
              ItemAbilityData.ORCHID_OF_MALEVOLENCE_DAMAGE_PERC * 100
            ).toFixed(1)}% of the damage received by the enemy is inflicted as bonus Magic Damage.` +
            '\n' +
    ...
    case ItemList.Divine_Staff_T2:
      return {
        ...
        desc: {
          en: `Heals all ally units in ${ItemAbilityData.ACTIVE_EFFECT_RADIUS}px radius for ${
            ItemAbilityData.DIVINE_STAFF_HEAL_T2
          } Health, grants bonus ${ItemAbilityData.DIVINE_STAFF_BONUS_SPEED} Movement Speed for ${(
    ...
    case ItemList.Vampiric_Shield:
      return {
        ...
        desc: {
          en: `When you take damage and your health falls below ${fixed(
            ItemAbilityData.VAMPIRIC_SHIELD_THRESHOLD * 100,
            1
          )}% Health, you remove all negative effects from yourself and receive ${
            ItemAbilityData.VAMPIRIC_SHIELD_HEALTH_REGEN
          } Health Regeneration for ${toSec(
            ItemAbilityData.VAMPIRIC_SHIELD_DURATION
          )} seconds. (Only triggers on player-based damage)`,
    ...
    case ItemList.GarunsDefender:
      return {
        ...
        desc: {
          en: `If you take damage below ${fixed(
            ItemAbilityData.GARUNS_DEFENDER_THRESHOLD * 100,
            1
          )}% health you unleash a shockwave with 0.5sec delay that stuns all nearby enemies for ${toSec(
            ItemAbilityData.GARUNS_DEFENDER_STUN_DURATION
          )} and deals ${
            ItemAbilityData.GARUNS_DEFENDER_DAMAGE
          } normal damage. This effect cannot trigger more than once every ${toSec(
    ...
    case ItemList.Plate_Shield:
      return {
        ...
        desc: {
          en: `Releases shockwave which travels through the air, dealing bonus ${
            ItemAbilityData.PLATE_SHIELD_DAMAGE_AOE
          } physical damage to enemies and reducing enemies' Movement Speed by ${
    ...
    case ItemList.Kirins_Defender:
      return {
        ...
        desc: {
          en: `Absorbs any Crowd Control effect every ${(
            ItemAbilityData.KIRINS_DEFENDER_COOLDOWN / 1000
          ).toFixed()} seconds. Sucessful block provides you ${calculateMagicDefense(
            ItemAbilityData.KIRINS_DEFENDER_BONUS_MR
          )} Magic Resistance for ${(ItemAbilityData.KIRINS_DEFENDER_DURATION / 1000).toFixed()} seconds.`,
    ...
    case ItemList.Demon_Sabre:
      return {
        ...
        desc: {
          en: `Enemies hit by your Basic Attacks have their armor reduced by ${Math.floor(
            ItemAbilityData.DEMON_SABRE_ARMOR_REDUCTION * 100
          )}% per stack (max ${ItemAbilityData.DEMON_SABRE_ARP_MAX_STACKS}) for 4 seconds.`,
    ...
    case ItemList.Demonic_Ring:
      return {
        ...
        desc: {
          en: `Your basic attacks lower the enemy's armor by ${fixed(
            ItemAbilityData.DEMON_RING_ARMOR_REDUCTION * 100,
            1
          )}% for 4 seconds. \n
                     For every minion kill (+1 stack), hero kill (+5 stacks) or assist (+2 stacks) you gain ${
                       ItemAbilityData.DEMON_RING_STACK_DMG
                     } Attack Damage (Max: ${
            ItemAbilityData.DEMON_RING_STACK_DMG * ItemAbilityData.DEMON_RING_MAX_STACKS
          } Attack Damage at 20 stacks). All stacks are lost upon death.`,
    ...
    case ItemList.Frost_Ring: {
      return {
        ...
        desc: {
          en: `Emits a freezing wave that deals ${
            ItemAbilityData.FROST_RING_DAMAGE
          } magic damage to enemies and apply Frigid Curse - (${getFrigidCurseDescription()}). If target is affected by Frigid curse, it will freeze the enemy for ${(
            ItemAbilityData.FROST_RING_ROOT_DURATION / 1000
          ).toFixed(1)} prevent from all movement.`,
    ...
    case ItemList.Chronos_Ring:
      return {
        ...
        desc: {
          en: `Whenever you cast an ability, reduce all your cooldowns by ${toSec(
    ...
    case ItemList.Berserker_Ring:
      return {
        ...
        desc: {
          en: `For each 3.33% HP you are missing. you gain ${Math.floor(
            ItemAbilityData.BERSERKER_RING_ATTACK_SPEED_PER_FRAG * 100
          )}% attack speed and ${ItemAbilityData.BERSERKER_RING_HEALTH_REGEN_PER_FRAG} health regen`,
    ...
    case ItemList.Frost_Armor:
      return {
        ...
        desc: {
          en: `Reduces the attack speed of all nearby enemies by ${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}% and all heals, regeneration and lifesteal by ${(
            ItemAbilityData.FROST_ARMOR_HPREDUC * 100
          ).toFixed()}%.`,
          ru: `Скорость атаки ближайших к вам врагов уменьшается на ${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}%, а все эффекты входящего исцеления и регенерации на ${(
            ItemAbilityData.FROST_ARMOR_HPREDUC * 100
          ).toFixed()}%.`,
          br: `Reduz a velocidade de ataque de todos os inimigos próximos em ${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}% e todas as curas, regeneração e roubo de vida em ${(
            ItemAbilityData.FROST_ARMOR_HPREDUC * 100
          ).toFixed()}%.`,
          fr: `Réduit la vitesse d'attaque de tous les ennemis à proximité de ${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}% et toutes les soins, la régénération et le vol de vie de ${(
            ItemAbilityData.FROST_ARMOR_HPREDUC * 100
          ).toFixed()}%.`,
          zh: `减少附近所有敌人的攻击速度${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}%，所有治疗，再生和生命偷取${(ItemAbilityData.FROST_ARMOR_HPREDUC * 100).toFixed()}%。`,
          cz: `Snižuje rychlost útoku všech blízkých nepřátel o ${(
            ItemAbilityData.FROST_ARMOR_ATTACK_SPEED_REDUCTION * 100
          ).toFixed()}% a všechny zotavení, regeneraci a životní sílu o ${(
            ItemAbilityData.FROST_ARMOR_HPREDUC * 100
          ).toFixed()}%.`,
        },
      }
    ...
    case ItemList.Void_Armor:
      return {
        ...
        desc: {
          en: `Gives you invisibility for ${(ItemAbilityData.VOID_ARMOR_DURATION / 1000).toFixed(
            1
          )} seconds granting you additional ${ItemAbilityData.VOID_ARMOR_MOVESPEED_BONUS} Movement Speed and ${
    ...
    case ItemList.Titans_Armor:
      return {
        ...
        desc: {
          ...
          } Health Regeneration and removing all negative effects. However, you cannot move, attack, use abilities or items during its effect.`,
    ...
    case ItemList.ChestOfMalevolence:
      return {
        ...
        desc: {
          en: `When you take magic damage, curse on the caster will be applied, reducing movement speed by ${
            ItemAbilityData.CHEST_OF_MALEVOLENCE_REDUCE_MS
          } and ability power by ${fixed(ItemAbilityData.CHEST_OF_MALEVOLENCE_REDUCE_AP * 100, 1)}%. (Stacks up to ${
    ...
    case ItemList.Healing_Potion:
      return {
        ...
        desc: {
          en: `Grants ${ItemAbilityData.HEALING_POTION_HEAL_PER_SEC} health regeneration for ${(
    ...
    case ItemList.Observer_Ward:
      return {
        ...
        desc: {
          en: `Plants an Observer Ward, an invisible watcher that gives obstructed vision in a ${
            ItemAbilityData.WARD_VISION
          } px radius to your team. Lasts ${(ItemAbilityData.WARD_DURATION / 1000).toFixed(
            1
    ...
    case ItemList.Kirins_Bow: {
      ...
      return {
        ...
        desc: {
          en: `Your basic attacks apply magical poison that explode at ${
            ItemAbilityData.KIRINS_BOW_MAX_STACKS
          } stack. Upon explosion deals ${
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          } magical damage, reduces ${asAndMsReduction}% attack speed for ${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
          zh: `你的基本攻击会施加魔法毒，抵达${ItemAbilityData.KIRINS_BOW_MAX_STACKS}层后爆炸，造成${
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          }魔法伤害，减少${asAndMsReduction}%魔法抗性和${asAndMsReduction}%攻击速度，持续${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
          cz: `Vaše základní útoky aplikují magickou jed, která exploduje při ${
            ItemAbilityData.KIRINS_BOW_MAX_STACKS
          } vrstvách. Při výbuchu způsobuje ${
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          } magické škody, snižuje ${asAndMsReduction}% rychlost útoku po dobu ${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
          fr: `Vos attaques de base appliquent un poison magique qui explose à ${
            ItemAbilityData.KIRINS_BOW_MAX_STACKS
          } pile. Lors de l'explosion, il inflige ${
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          } dégâts magiques, réduit la vitesse d'attaque de ${asAndMsReduction}% pendant ${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
          br: `Seus ataques básicos aplicam veneno mágico que explodem em ${
            ItemAbilityData.KIRINS_BOW_MAX_STACKS
          } pilhas. Ao explodir, causa ${
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          } dano mágico, reduz ${asAndMsReduction}% de velocidade de ataque por ${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
          ru: `Ваши базовые атаки накладывают волшебный яд, который взрывается при достижении  ${
            ...
            ItemAbilityData.KIRINS_BOW_TRIGGER_DAMAGE_OVER_TIME
          } магического урона, уменьшает Скорость атаки на  ${asAndMsReduction}% на ${toSec(
            ItemAbilityData.KIRINS_BOW_DURATION
          )}`,
        },
      }
    ...
    case ItemList.Garuns_Charm: {
      return {
        ...
        desc: {
          en: `Every ${toSec(ItemAbilityData.GARUNS_CHARM_REPLENISH_COOLDOWN)} gains additional ${
            ItemAbilityData.GARUNS_CHARM_BONUS_ARMOR_STACK
          } armor (up to ${ItemAbilityData.GARUNS_CHARM_MAX_STACKS} stacks). (Normal damage breaks 1 layer)\nGrants ${
    ...
    case ItemList.Wizard_Charm: {
      return {
        ...
        desc: {
          en: `Reduces the magic resistance and positive auras duration to all nearby enemies by ${fixed(
    ...
    case ItemList.Corrupted_Locket: {
      return {
        ...
        desc: {
          en: `Your critical hits against heroes provide additional ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE
          } damage and ${ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS} move speed for ${toSec(
            ItemAbilityData.CORRUPTED_LOCKET_DURATION
          )}. (Stacks up to ${ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS} times)`,
          br: `Seus ataques críticos contra heróis proporcionam dano adicional de ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE
          } e velocidade de movimento de ${ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS} por ${toSec(
            ItemAbilityData.CORRUPTED_LOCKET_DURATION
          )}. (Empilha até ${ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS} vezes)`,
          fr: `Vos coups critiques contre les héros procurent ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE
          } points de dégâts supplémentaires et ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS
          } de vitesse de déplacement pendant ${toSec(ItemAbilityData.CORRUPTED_LOCKET_DURATION)}. (empILABLE jusqu'à ${
            ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS
          } fois)`,
          zh: `您對英雄的暴擊將獲得額外的${ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE}傷害和${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS
          }移動速度，持續時間為${toSec(ItemAbilityData.CORRUPTED_LOCKET_DURATION)}。 (最多可堆疊${
            ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS
          }次)`,
          cz: `Vaše kritické útoky proti hrdinům poskytují dodatečné poškození ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE
          } a rychlost pohybu ${ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS} po dobu ${toSec(
            ItemAbilityData.CORRUPTED_LOCKET_DURATION
          )}. (Nahromadí se až ${ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS}krát)`,
          ru: `Ваши критические удары наносят героям дополнительно ${
            ItemAbilityData.CORRUPTED_LOCKET_BONUS_DAMAGE
          } урона и дают вам ${ItemAbilityData.CORRUPTED_LOCKET_BONUS_MS} Скорости передвижения на ${toSec(
            ItemAbilityData.CORRUPTED_LOCKET_DURATION
          )} (складывается до ${ItemAbilityData.CORRUPTED_LOCKET_MAX_STACKS} раз)`,
        },
      }
    }
    default:
...
const getPoisonBowDescription = (duration: number) => {
  const text: { [key: string]: string } = {
    en: `Enemies hit by your Basic Attacks will be infected by deadly poison, reducing their movement speed by ${
      ItemAbilityData.POISON_BOW_SLOW
    } and dealing ${ItemAbilityData.POISON_BOW_DAMAGE_OVER_TIME} magic damage per second for ${(
      duration / 1000
    ).toFixed(1)} seconds. (This effect stacks up 5 times.)`,
...
export const getFrigidCurseDescription = () => {
  const text: { [key: string]: string } = {
    en: `Reduce movement speed by ${ItemAbilityData.FRIGIT_CURSE_SLOW} and all healing and regeneration effects by ${(
