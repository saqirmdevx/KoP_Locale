        ...
        return {
            ...
            tier1_right: {
                ...
                description: {
                    ...
                    } скорости передвижения и ${AlvarAbilityData.TALENT_FURIOUS_KICK_BONUS_AS * 100
                    }% скорости атаки на ${toSec(
                        AlvarAbilityData.TALENT_FURIOUS_KICK_DURATION
                    )}`,
                },
            },
...
export const getDamage = (
    ...
    /** dont show % in game */
    return `<span class=${type === Shared.DamageTypes.NORMAL
        ? 'normal-d'
