      ...
      return {
        ...
        tier2_left: {
          title: {
            ...
            vi: `Hồn Ma xuyên thủ ${MagdaleneAbilityData.TALENT_T2_LEFT_HAUNTED_GHOST_PIERCE_TARGETS} mục tiêu`,
          },
        },
        tier2_right: {
          title: {
            ...
            vi: `+${MagdaleneAbilityData.TALENT_T2_RIGHT_MOVEMENT_SPEED_PER_STACK}% tốc độ di chuyển cho mỗi stack`,
          },
        },
      }
    }
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Kích hoạt hình dạng khiến người chơi gần đó sợ hãi`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Sáng Ân Cần +${SeerAbilityData.TALENT_T1_RIGHT_BENEVOLENT_FLARE_MOVEMENT_SPEED}% tốc độ di chuyển`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `+${toSec(SeerAbilityData.TALENT_T2_LEFT_MALEVOLENT_FORM_DURATION)}s thời gian tồn tại của hình dạng ác ý`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `AOE ác ý/tốt +${SeerAbilityData.TALENT_T2_RIGHT_CURSE_BONUS_RADIUS}`,
