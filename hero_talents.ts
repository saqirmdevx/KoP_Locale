      ...
      return {
        ...
        tier1_right: {
          title: {
            ...
            vi: `Cầu Ma Thuật trúng hai lần +${magicalOrbDoubleHitBonus}%`,
          ...
          description: {
            ...
            vi: `Trúng cùng một mục tiêu hai lần với Cầu Ma Thuật trong ${magicalOrbMarkDuration} gây thêm <c:bonus>${magicalOrbDoubleHitBonus}% sát thương</c:bonus>.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Phi Thân Ma Pháp ${dashCharges} lần tích trữ`,
          ...
          description: {
            ...
            vi: `Phi Thân Ma Pháp có ${dashCharges} lần tích trữ, hồi lại từng lượt một.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Cầu Ma Thuật sẽ giảm thị lực những tướng địch mà nó bay xuyên qua. Tướng địch sẽ bị <c:vision>giảm tầm nhìn</c:vision> và không chia sẻ <c:vision>tầm nhìn</c:vision> với đồng đội trong <c:control>${blindDuration}</c:control>`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Quỷ Nộ gây thêm <c:bonus>${missingHealthBonus}% lượng máu đã mất</c:bonus> của mục tiêu thành sát thương.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tà Phong ${corruptedWindCooldown}s`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Đòn đánh cường hóa ${enhancedAttackDamage}%`,
          ...
          description: {
            ...
            vi: `Đòn đánh cường hóa của Sparrow gây <c:bonus>${enhancedAttackDamage}% sát thương</c:bonus> thay vì ${baseEnhancedAttackDamage}%.`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Đòn đánh cường hóa +${knockUpBonus}s choáng`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Mảnh Băng Tiễn +${icicleFreezeDuration}s đóng băng`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tốc chạy của Hàn Ủng +${fixed(ICeatAbilityData.TALENT_T1_RIGHT_COLD_EMBRACE_BONUS_MS * 100, 1)}%`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Đòn đánh thường của I'Ceat lên mục tiêu <c:freeze>đóng băng</c:freeze> gây thêm <c:magical>${frozenAttackBonusDamage}% sức mạnh phép thuật dưới dạng sát thương phép</c:magical>.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Kẻ địch đứng trên vệt băng của Hàn Ủng trong ${deepFrostStacks} nhịp sát thương sẽ bị <c:freeze>đóng băng</c:freeze> trong ${deepFrostFreezeDuration} ở nhịp tiếp theo.`,
      ...
      return {
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tinh Kiếm ${astralBladesCooldown}s`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Sát thương cường hoá +${fixed((VeilAbilityData.TALENT_T2_LEFT_ENHANCED_STATE_DAMAGE - 1) * 100, 1)}%`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              `Giảm thời gian hồi chiêu của Tinh Bộ đi ${astralStepCooldown} \n` +
              'Tinh Bộ ở trạng thái cường hóa không còn loại bỏ trạng thái cường hóa.',
            id:
      ...
      return {
        ...
        tier1_right: {
          title: {
            ...
            vi: `Thiên Nhiên Tái Sinh +${floralRejuvenationHealBonus}% Hồi máu`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Tầm của Tên Chính Xác +${preciseShotRange}%`,
          ...
          description: {
            ...
            vi: `Tên Chính Xác bay <c:bonus>xa hơn ${preciseShotRange}%</c:bonus>.`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Hệ số sát thương của Tên Chính Xác ở khoảng cách tối đa tăng từ <c:bonus>${deadeyeBase}%</c:bonus> lên <c:bonus>${deadeyeMax}%</c:bonus>.`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Bước Lùi ${backstepCharges} lần tích trữ`,
          ...
          description: {
            ...
            vi: `Bước Lùi tích trữ ${backstepCharges} lần tích trữ, hồi lại lần lượt từng lần một.`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Sát thương Huyết Kiếm ${bleedDamage}%`,
          ...
          description: {
            ...
            vi: `Huyết Kiếm gây <c:physical>${bleedDamage}% sát thương vật lí của Thomas</c:physical> trong suốt thời gian đòn đánh có hiệu lực.`,
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Mỗi Shuriken bay qua trúng tướng địch sẽ cộng dồn Huyết Kiếm.`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Huyết Kiếm kích hoạt sau ${bleedAttackCount} đòn đánh thường thay vì ${baseBleedAttackCount}.`,
      ...
      return {
        ...
        tier1_right: {
          title: {
            ...
            vi: `Nộ Cước +${furiousKickLifesteal}% khát máu`,
          ...
          description: {
            ...
            vi: `Nộ Cước <c:lifesteal>tăng khát máu thêm ${furiousKickLifesteal}%</c:lifesteal>`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Thiên Cước ${heavenlyKickCooldown}s`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Viên đạn thứ hai +${secondBulletBonusDamage}% Sát thương`,
          ...
          description: {
            ...
            vi: `Viên đạn được nạp gây <c:bonus>${secondBulletUpgradedDamage}% sát thương vật lí</c:bonus> thay vì ${secondBulletDamage}%.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Nhào Lộn ${tumbleCharges} lần tích trữ`,
          ...
          description: {
            ...
            vi: `Nhào Lộn có ${tumbleCharges} lần tích trữ, hồi lại từng lượt một.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              `Nhào Lộn đặt ra một bẫy <c:freeze>đóng băng</c:freeze> tại vị trí của Arel. Khi một đơn vị địch bước vào bẫy, chúng sẽ bị <c:control>đóng băng trong ${freezingTrapFreezeDuration}</c:control>, ngăn chặn mọi hình thức di chuyển.` +
              `<br/> Bẫy tồn tại trong ${freezingTrapDuration} và <c:vision>cung cấp tầm nhìn</c:vision> trong khoảng bán kính nhỏ.`,
            id:
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Khải Hoàn Chấn Động ban cho Hazel một <c:heal>lá chắn bằng ${HazelAbilityData.TALENT_T1_LEFT_TRIUMPHANT_UPHEAVAL_SHIELD * 100}% sát thương gây ra</c:heal>, kéo dài ${toSec(HazelAbilityData.TALENT_T1_LEFT_TRIUMPHANT_UPHEAVAL_SHIELD_DURATION)}.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Tốc chạy Da Đá +${stoneSkinMovementSpeed}%`,
          ...
          description: {
            ...
            vi: `Da Đá cấp thêm <c:bonus>${stoneSkinMovementSpeed}% tốc chạy</c:bonus>.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Sức Mạnh Công Lý +${toSecRaw(HazelAbilityData.TALENT_T2_LEFT_JUSTICES_WRATH_STUN_DURATION)}s choáng`,
        ...
        tier2_right: {
          title: {
            ...
            vi: `Cường Hóa Khải Hoàn Chấn Động`,
          ...
          description: {
            ...
            vi: `Khải Hoàn Chấn Động gây thêm sát thương bằng <c:physical>${HazelAbilityData.TALENT_T2_RIGHT_TRIUMPHANT_UPHEAVAL_BONUS_DAMAGE_HP * 100}% máu tối đa của Hazel</c:physical>.`,
      ...
      return {
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Sét giờ có thể chuỗi đến đơn vị gần nhất, có thể là địch hoặc đồng minh và áp dụng hiệu ứng Liên Hoàn Sét <c:bonus>giảm 25%</c:bonus> sức mạnh mỗi lần.`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Lựu Đạn châm ngòi kẻ địch, gây <c:magical>${incendiaryGrenadeDamage}% máu tối đa của mục tiêu dưới dạng sát thương phép</c:magical> mỗi giây trong thời gian ngắn.`,
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Lựu Đạn <c:control>đóng băng kẻ thù trong ${freezingGrenadeDuration}</c:control>, ngăn mọi hình thức di chuyển`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Súng Rực Lửa giảm thời gian hồi chiêu đi ${gunsBlazingTotalReduction}s thay vì ${gunsBlazingBaseReduction}s.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Foxy không còn bị làm chậm khi dùng Tốc Xạ mà thay vào đó nhận <c:bonus>${rapidFireMovementSpeed}% tốc chạy</c:bonus> trong lúc đó.`,
      ...
      return {
        ...
        tier2_left: {
          title: {
            ...
            vi: `Hồn Ma xuyên qua ${MagdaleneAbilityData.TALENT_T2_LEFT_HAUNTED_GHOST_PIERCE_TARGETS} mục tiêu địch`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Cầu cung cấp thêm <c:bonus>${primBonusMovementSpeed}% tốc chạy</c:bonus> và <c:bonus>${primBonusArmor} giáp</c:bonus> khi cầu gắn vào Prim.`,
        ...
        tier1_right: {
          title: {
            ...
            vi: `Khoảng cách tối đa cầu +${PrimAbilityData.TALENT_T1_RIGHT_BALL_ADDITIONAL_DISTANCE}px`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Tăng <c:magical>sát thương</c:magical> và <c:stun>choáng</c:stun> của Lực Hấp Dẫn lên <c:bonus>${gravitationalPullBonus}%</c:bonus>`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Dịch Chuyển Tà Ác để lại một bản sao bóng tối tại vị trí cũ của Seer, gây <c:bonus>${mirrorDamage}% sát thương của bản sao bóng tối</c:bonus>.`,
        ...
        tier2_left: {
          title: {
            ...
            vi: `Dịch Chuyển Tà Ác ${shiftCharges} tích trữ`,
          ...
          description: {
            ...
            vi: `Dịch Chuyển Tà Ác có ${shiftCharges} lần tích trữ, hồi lại lần lượt từng lượt một.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Dịch Chuyển Tà Ác còn <c:root>trói chân tất cả tướng địch trúng đòn trong ${clawsRoot}</c:root>.`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Đánh trúng tướng địch bằng Quật Gai giảm thời gian hồi chiêu còn lại của Thịnh Nộ Rừng Thiêng đi ${briarConnectionCooldownReduction}.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Thịnh Nộ Rừng Thiêng triệu hồi hạt giống thứ hai sau ${additionalWrathDelay}. Lần bùng nổ này gây <c:magical>${additionalWrathMod}% sát thương</c:magical> và cùng hiệu ứng <c:stun>choáng</c:stun>.`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Rối lao làm chậm +${dashSlowBonus}s`,
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Lệnh: Tấn Công <c:physical>giảm ${shredderArmorPerStack} giáp mục tiêu mỗi lớp</c:physical> (tối đa ${shredderMaxStacks} lớp, ${shredderMaxArmor} tối đa) trong ${shredderDuration}.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Sợi dây <c:control>trói</c:control> của Sợi Chỉ Trói Buộc kéo dài thêm ${staticDurationBonus} và làm <c:stun>choáng thêm ${stunDurationBonus}</c:stun>.`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Khiên của Tiên Phong <c:heal>mạnh hơn ${vanguardShieldBonus}%</c:heal>, và ban cho đồng minh bị xuyên qua (cả bản thân Patroklos) <c:bonus>${vanguardAllySpeed}% tốc chạy</c:bonus> và <c:bonus>${vanguardAllyAttackSpeed}% tốc độ đánh</c:bonus> trong ${vanguardAllyDuration}.`,
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Tiên Phong có ${vanguardCharges} lượt tích trữ, hồi lại từng lượt một.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Mục tiêu trúng đòn với tối đa ${lastJudgementMaxStacks} cộng dồn Thiên Phạt chịu thêm <c:pure>${lastJudgementMaxHealthDamage}% máu tối đa dưới dạng sát thương chuẩn</c:pure> từ mỗi thanh kiếm của Thiên Phán (tổng ${lastJudgementTotalMaxHealthDamage}%). Thiên Phán còn <c:heal>hồi máu bằng ${lastJudgementHeal}% sát thương gây ra</c:heal> thay vì ${divineReckoningHeal}%.`,
