      ...
      return {
        tier1_left: {
          title: {
            ...
            cz: 'Lightning Shock Disperze',
            zh: 'Lightning Shock 分散',
            fr: 'Lightning Shock Dispersion',
            br: 'Lightning Shock Dispersão',
          },
          description: {
            ...
            cz: 'Lightning Shock aplikuje disperzi na nepřátelské hrdiny, což snižuje veškeré léčení o 35%',
            zh: 'Lightning Shock 在敌方英雄身上施加分散，减少所有治疗效果35%',
            fr: 'Lightning Shock applique une dispersion sur les héros ennemis, réduisant tous les soins de 35%',
            br: 'Lightning Shock aplica dispersão nos heróis inimigos, reduzindo toda a cura em 35%',
          },
        },
        tier1_right: {
          title: {
        ...
        tier2_right: {
          title: {
            ...
            cz: '+1 Lightning Shock Cíl',
            zh: '+1 Lightning Shock 目标',
