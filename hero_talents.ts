      ...
      return {
        ...
        tier2_left: {
          title: {
            ...
            vi: `Dòn đánh cường hóa ${enhancedAttackDamage}%`,
      ...
      return {
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Đòn đánh thường của I'Ceat lên mục tiêu <c:control>đóng băng</c:control> gây thêm <c:magical>${frozenAttackBonusDamage}% sức mạnh phép thuật dưới dạng sát thương phép</c:magical>.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Kẻ địch đứng trên vệt băng của Hàn Ủng trong ${deepFrostStacks} trong thời gian hứng chịu sát thương sẽ bị <c:control>đóng băng</c:control> trong ${deepFrostFreezeDuration} ở thời tiếp theo.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              ...
              'Tinh Bộ ở trạng tháng cường hóa không còn loại bỏ trạng thái cường hóa.',
            id:
      ...
      return {
        ...
        tier2_left: {
          title: {
            ...
            vi: `Hoa Phục Kích +${floralAmbushDurationBonus}s thời lượng`,
          ...
          description: {
            ...
            vi: `Bom hạt của Hoa Phục Kích tồn tại lâu hơn ${floralAmbushDurationBonus}s, gây sát thương theo thời gian lâu hơn và <c:bonus>tăng tổng lượng sát thương</c:bonus>.`,
      ...
      return {
        ...
        tier2_left: {
          ...
          description: {
            ...
            vi: `Khoảng cách tối đa của Tên Chính Xác tăng từ <c:bonus>${deadeyeBase}%</c:bonus> lên <c:bonus>${deadeyeMax}%</c:bonus>.`,
      ...
      return {
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi:
              `Nhào Lộn đặt ra một bẫy <c:control>đóng băng</c:control> tại vị trí của Arel. Khi một đơn vị địch bước vào bẫy, chúng sẽ bị <c:control>đóng băng trong ${freezingTrapFreezeDuration}</c:control>, ngăn chặn mọi hình thức di chuyển.` +
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Khải Hoàn Chấn Động ban cho Hazel một <c:heal>lá chắn bằng ${HazelAbilityData.TALENT_T1_LEFT_SHOCKWAVE_SHIELD * 100}% sát thương gây ra</c:heal>, kéo dài ${toSec(HazelAbilityData.TALENT_T1_LEFT_SHOCKWAVE_SHIELD_DURATION)}.`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Khải Hoàn Chấn Động gây thêm sát thương bằng <c:physical>${HazelAbilityData.TALENT_T2_RIGHT_SHOCKWAVE_BONUS_DAMAGE_HP * 100}% máu tối đa của Hazel</c:physical>.`,
      ...
      return {
        tier1_left: {
          title: {
            ...
            vi: `Điện Kích +${toSecRaw(KiraAbilityData.TALENT_T1_LEFT_ENH_ATTACK_DURATION)}s`,
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Sét giờ có thể chuỗi đến đơn vị gần nhất, có thể là địch hoặc đồng minh và áp dụng hiệu ứng Liện Hoàn Sét <c:bonus>giảm 25%</c:bonus> sức mạnh mỗi lần.`,
      ...
      return {
        tier1_left: {
          ...
          description: {
            ...
            vi: `Cầu cung cấp thêm <c:bonus>${primBonusMovementSpeed}% tốc chyaj</c:bonus> và <c:bonus>${primBonusArmor} giáp</c:bonus> khi cầu gắn vào Prim.`,
      ...
      return {
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Dịch Chuyển Tà Ác còn <c:control>trói chân tất cả tướng địch trúng đòn trong ${clawsRoot}</c:control>.`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Đánh trúng tướng địch bằng Quật Gai giảm ${briarConnectionCooldownReduction} còn lại Thịnh Nộ Rừng Thiêng.`,
      ...
      return {
        ...
        tier1_right: {
          ...
          description: {
            ...
            vi: `Rối lao <c:physical>giảm ${shredderArmorPerStack} giáp mục tiêu mỗi lớp</c:physical> (tối đa ${shredderMaxStacks} lớp, ${shredderMaxArmor} tối đa) trong ${shredderDuration}.`,
      ...
      return {
        ...
        tier2_right: {
          ...
          description: {
            ...
            vi: `Mục tiêu trúng đòn với tối đa ${lastJudgementMaxStacks} cộng dồn Thiên Phạt chịu thêm <c:pure>${lastJudgementMaxHealthDamage}% máu tối đa dưới dạng sát thương xuyên giáp</c:pure> từ mỗi thanh kiếm của Thiên Phán (tổng ${lastJudgementTotalMaxHealthDamage}%). Thiên Phán còn <c:heal>hồi máu bằng ${lastJudgementHeal}% sát thương gây ra</c:heal> thay vì ${divineReckoningHeal}%.`,
