...
export const home_page: { [key in LOCALE]?: { [key in string]: string } } = {
  ...
  [LOCALE.LANDING_ABOUT_TEXT]: {
    ...
    vi: 'Kingdom of Pixels là game MOBA platformer cuộn cảnh ngang 2D nhiều người chơi trực tuyến, nơi người chơi chọn những tướng độc đáo, chiến đấu trong những trận đấu nhịp độ nhanh và vượt qua đối thủ bằng kỹ năng, phối hợp và chiến thuật.',
  ...
  [LOCALE.LANDING_MULTIPLAYER_TITLE]: {
    ...
    vi: 'Trải nghiệm chơi trực tuyến thực thụ',
  ...
  [LOCALE.LANDING_MULTIPLAYER_TEXT]: {
    ...
    vi: 'Bước vào đấu trường chiến đấu trực tuyến cường độ cao, nơi từng giây đều quan trọng. Chơi cùng bạn bè, chọn tướng tủ và thống trị bằng kỹ năng. Không có lối tắt, chỉ có lối chơi nhanh, cơ chế sắc bén và cạnh tranh thực sự trong Kingdom of Pixels.',
  ...
  [LOCALE.LANDING_MULTIPLAYER_IMAGE_ALT]: {
    ...
    vi: 'Trận chiến trực tuyến Kingdom of Pixels',
  ...
  [LOCALE.LANDING_TUTORIAL_IMAGE_ALT]: {
    ...
    vi: 'Hướng dẫn lối chơi Kingdom of Pixels',
  ...
  [LOCALE.LANDING_OBJECTIVES_TEXT]: {
    ...
    vi: 'Thích nghi với từng trận đấu thông qua tướng, trang bị và các mục tiêu trên bản đồ luôn thay đổi theo cách trận đấu diễn ra. Quyết định thông minh, đúng thời điểm và chiến thuật quan trọng không kém kỹ năng phản xạ, khiến mỗi cuộc chiến có nhịp độ khác nhau.',
  ...
  [LOCALE.LANDING_OBJECTIVES_IMAGE_ALT]: {
    ...
    vi: 'Ngọc Vàng trong Kingdom of Pixels',
  ...
  [LOCALE.LANDING_HERO_CAROUSEL_TEXT]: {
    ...
    vi: 'Kết hợp các vị tướng, trang bị và mục tiêu khác nhau để tạo nên lối chơi của riêng bạn. Mỗi trận đấu đều mang đến những tình huống mới, giúp lối chơi luôn mới mẻ và cuốn hút từ đầu đến cuối.',
  ...
  [LOCALE.LANDING_FAQ_MULTIPLAYER_QUESTION]: {
    ...
    vi: 'Kingdom of Pixels có phải trò chơi trực tuyến không?',
  ...
  [LOCALE.LANDING_FAQ_MULTIPLAYER_ANSWER]: {
    ...
    vi: 'Có, đây là trò chơi trực tuyến nơi người chơi cạnh tranh trong các trận đấu thời gian thực.',
  ...
  [LOCALE.LANDING_FAQ_FRIENDS_ANSWER]: {
    ...
    vi: 'Có, bạn có thể tạo phòng tùy chỉnh để chơi cùng bạn bè. Bạn cũng có thể chọn đội trong các trận đấu xếp hạng.',
  ...
  [LOCALE.LANDING_FAQ_COMMUNITY_QUESTION]: {
    ...
    vi: 'Có cộng đồng Kingdom of Pixels không?',
  ...
  [LOCALE.LANDING_FAQ_COMMUNITY_ANSWER_PREFIX]: {
    ...
    vi: 'Có, chúng tôi có Discord nơi bạn có thể trò chuyện với những người chơi khác hoặc nhà phát triển của trò chơi. ',
  ...
  [LOCALE.LANDING_FAQ_MOBILE_QUESTION]: {
    ...
    vi: 'Trò chơi có chơi được trên di động không?',
  ...
  [LOCALE.LANDING_FAQ_SIGNIN_ANSWER_PREFIX]: {
    ...
    vi: 'Để có tài khoản lâu dài, bạn có thể đăng nhập bằng tài khoản Google. Bạn cũng có thể chơi trên ',
  ...
  [LOCALE.RENAME_ERROR_ALREADY_EXISTS]: {
    ...
    vi: 'Tên đã được sử dụng. Chọn một tên khác!',
  ...
  [LOCALE.PLAY_PAGE_RANKED_DESCRIPTION]: {
    ...
    ru: ' - Награды: опыт, монеты и Очки рейтинга\n - Соло рейтинг играет только против соло\n - Группа в рейтинге играет только против группы',
    cz: ' - Odměna: zkušenosti, mince a ELO\n - Solo ranked hraje jen proti solo\n - Party ranked hraje jen proti party',
    zh: ' - 獎勵：經驗值、金錢和ELO值\n - 單排只會對上單排\n - 組排只會對上組排',
    fr: ' - Récompense : expérience, pièces et ELO\n - Le classé solo joue seulement contre du solo\n - Le classé en groupe joue seulement contre des groupes',
    br: ' - Recompensa: experiência, moedas e ELO\n - Ranked solo joga apenas contra solo\n - Ranked em grupo joga apenas contra grupos',
    vi: ' - Phần thưởng: kinh nghiệm, xu và elo\n - Đấu hạng đơn chỉ gặp đấu đơn\n - Đấu hạng tổ đội chỉ gặp tổ đội',
  ...
  [LOCALE.LOW_PRIORITY_QUEUE_MESSAGE]: {
    ...
    vi: 'Bị cấm xếp hạng. Thắng {} trận đấu thường để chơi xếp hạng.',
  ...
  [LOCALE.RANKED_PLAYERS_AND_TIME]: {
    en: '10 min - Solo / Party 2V2',
    ru: '10 мин - соло / пати 2 на 2',
    br: '10 min - Solo / Party 2V2',
    cz: '10 min - solo / parta 2v2',
    zh: '10 分鐘 - 单排 / 组队 2v2',
    fr: '10 min - Solo / Groupe 2v2',
    vi: '10 phút - Đấu đơn / Tổ đội 2v2',
    id: '10 menit - Solo / Party 2v2',
    kr: `10 분 - 솔로 / 파티 2v2`,
  },
  [LOCALE.CASUAL_PLAYERS_AND_TIME]: {
    en: '8/10 min - 1V1/2V2',
    ru: '8/10 мин - 1на1/2на2',
    br: '8/10 min - 1V1/2V2',
    cz: '8/10 min - 1V1/2V2',
    zh: '8/10 分鐘 - 1V1/2V2',
    fr: '8/10 min - 1V1/2V2',
    vi: '8/10 phút - 1V1/2V2',
    id: '8/10 menit - 1V1/2V2',
    kr: `8/10 분 - 1v1/2v2`,
  },
