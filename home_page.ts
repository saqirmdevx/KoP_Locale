...
export const home_page: { [key in LOCALE]?: { [key in string]: string } } = {
  ...
  [LOCALE.LANDING_MULTIPLAYER_TEXT]: {
    ...
    vi: 'Bước vào đấu trường chiến đấu trực tuyến cường độ cao, nơi từng giây đều quan trọng. Chơi cùng bạn bè, chọn tướng tủ và thống trị bằng kỹ năng thuần túy. Không có lối tắt, chỉ có lối chơi nhanh, cơ chế sắc bén và cạnh tranh thực sự trong Kingdom of Pixels.',
